...
export default function Index() {
  ...
  return (
    ...
    <Section title="Blog Intro">
      ...
      <div className="mb-4">In the end, we get controversial reviews about things liks designing curriculums, running classrooms, school schedules that are difficult to make use of. Regardless, I admire this diversity even if it makes life a little harder because it makes way to new thinking and ideas. Unfortunately, much of the literature don't shed enough insight on those ideas. However, it's the thoughts we don't get to know about that we find most interesting. Here, I do my best to share mine.
      </div>
